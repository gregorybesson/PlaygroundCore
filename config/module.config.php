...
return array(
        ...
        'routes' => array(
            'frontend' => array(
            	...
            	'options' => array(
            		...
            		'defaults' => array(
         				'controller' => 'PlaygroundCore\Controller\Dashboard',
            			'action'     => 'index',
            		),
            		'spec' => '/%channel%/',
            	),
                ...
                'child_routes' => array(
                    ...
                    'system' => array(
                        ...
                        'options' => array(
                            'route'    => '/system',
                            'defaults' => array(
                                'controller' => 'PlaygroundCore\Controller\System',
                                'action'     => 'index',
                            ),
                        ),
                        'may_terminate' => true,
    ...
    'controllers' => array(
        'invokables' => array(
            ...
            'PlaygroundCore\Controller\System'    => 'PlaygroundCore\Controller\SystemController',
